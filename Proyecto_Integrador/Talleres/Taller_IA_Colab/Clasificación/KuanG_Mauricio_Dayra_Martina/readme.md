...
4. Ecuación de la Recta
   ...
   Entoncones la recta queda de la forma: y = 0.951(x) - 0.295
    ...
    Además, el intercepto representa el Daily AQI value estimado cuando la concentración de NO₂ es cero, es decir -0.295, mientras que la pendiente representa cuánto cambia
    el AQI por cada unidad adicional de NO₂.
