...
| 25/08/26 | E | **Geometría:** El sistema deberá manipular papas de distintos tamaños, incluyendo tubérculos pequeños, evitando caídas o atascos durante el proceso. A través de un sistema de volteadores lo suficientemente largo, que permite un giro de 360 grados de la papa a analizar| DK |
| 27/08/26 | E | **Cinemática:** El transporte deberá desplazar, orientar y permitir el giro de las papas de manera controlada para facilitar su inspección sin producir daños. | DQ |
...
| 24/09/26 | E | **Inspección visual:** Las imágenes deberán capturarse con una iluminación adecuada para identificar color, textura, forma y defectos externos. | NA |
...
| 05/11/26 | D | **Costos:** Se priorizarán componentes comerciales y reutilizables para mantener un costo accesible de fabricación conforme a la problemática establecida y publico objetivo. | JM |
...
* **[1] Gamez-Rojas, G., Fuertes-Guerrero, C., & Mejía-España, D. (2025).** *Fumigación con etanol como tratamiento para inhibir la brotación en papa criolla colombiana (Solanum phureja).* TecnoLógicas, 28(63).
* **[2] Seminario-Cunya, J. F., Villanueva-Guevara, R., & Valdez-Yopla, M. H. (2018).** *Rendimiento de cultivares de papa amarillos precoces del grupo Phureja.* Agronomía Mesoamericana, 29(3), 639–653.
* **[3] Ruiz Santa Cruz, Y. F., & Sánchez Torres, M. R. (2024).** *Método de clasificación automática para defectos externos de Solanum phureja.* Universidad Señor de Sipán.
...
* **[11] ISO 7250-1:2017.** *Basic human body measurements for technological design.*
* **[12] ISO 22000:2018.** *Food safety management systems.*
* **[13] VDI/VDE 2206:2021.** *Development of mechatronic and cyber-physical systems.*
